...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <!-- Essa section renderizara  os conteudos especificos da view-->
    ...
    <!-- plugins:js -->
    <script src="http://localhost/foodDelivery/public/admin/vendors/base/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page-->
    <script src="http://localhost/foodDelivery/public/admin/vendors/chart.js/Chart.min.js"></script>
    <script src="http://localhost/foodDelivery/public/admin/vendors/datatables.net/jquery.dataTables.js"></script>
