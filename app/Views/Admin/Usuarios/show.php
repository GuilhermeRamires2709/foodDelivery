...
<div class="row">
    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="mt-4">
            <a href="<?= site_url('admin/usuarios/editar/$usuario->id'); ?>" class="btn btn-dark btn-sm">Editar</a>
            
            <a href="<?= site_url('admin/usuarios/apagar/$usuario->id'); ?>" class="btn btn-danger btn-sm">Apagar</a>
